...
require('lazy').setup({
  ...
  -- RILEYS EXTRA ADDED PLUGINS
  { -- org documents for neovim
    "nvim-neorg/neorg",
...
-- RILEY NOTE: LEARN MORE ABOUT TELESCOPE
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'help', 'vim' , 'bash'},
